...
import shared.commands.RoadBuilding;
...
public class RoadBuildingHandler extends BaseHandler{
    ...
    public void handle(HttpExchange request) throws IOException{ 
        ...
        if(super.getUser() == null ){
            ...
            body = new Gson().fromJson(body, RoadBuilding.class).serverExecute(new MovesFacade(super.getUser()));
