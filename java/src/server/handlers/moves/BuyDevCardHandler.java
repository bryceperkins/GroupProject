...
import shared.commands.BuyDevCard;
...
public class BuyDevCardHandler extends BaseHandler{
    ...
    public void handle(HttpExchange request) throws IOException{ 
        ...
        if(super.getUser() == null ){
            ...
            body = new Gson().fromJson(body, BuyDevCard.class).serverExecute(new MovesFacade(super.getUser()));
