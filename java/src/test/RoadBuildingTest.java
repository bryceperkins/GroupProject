...
public class RoadBuildingTest {
    ...
    @Test
    public void test_RoadBuilding_mock() {
        command = new RoadBuilding(PlayerIndex.Player1, new EdgeLocation(new HexLocation(1,1),EdgeDirection.SouthWest), new EdgeLocation(new HexLocation(1,1),EdgeDirection.NorthWest));
