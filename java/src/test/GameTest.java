...
public class GameTest {
    ...
    public void setUp() {
		...
		test_player1 = new Player(Color.puce,"Alice", 1, PlayerIndex.Player1, 1);
		test_player2 = new Player(Color.puce, "Alice", 2, PlayerIndex.Player2, 2);
		test_player3 = new Player(Color.puce,"Alice", 3, PlayerIndex.Player3, 3);
		test_player4 = new Player(Color.puce, "Alice", 4, PlayerIndex.Player4, 4);
        test_game = new Game();
