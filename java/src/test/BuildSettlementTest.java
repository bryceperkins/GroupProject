...
public class BuildSettlementTest {
    ...
    @Test
    public void test_BuildSettlement_mock() {
        command = new BuildSettlement(PlayerIndex.Player1, new VertexLocation(new HexLocation(1,1),VertexDirection.SouthWest), true);
